...
class TelevisionListView(generics.ListCreateAPIView):
...
class TelevisionDetails(generics.mixins.RetrieveModelMixin,
    ...
    def delete(self, request, *args, **kwargs):
        ...
        list_basestation = Basestation.objects.filter(television=instance)
        if len(list_basestation) > 0:
            msg = _('You cannot delete television if television have one or many basestation.')
